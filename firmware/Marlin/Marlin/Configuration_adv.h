...
#define SENSORLESS_BACKOFF_MM  { 2, 20 }     // (mm) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 10, 0, 2 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 1, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
